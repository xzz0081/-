...
pub struct TokenBalance {
    ...
    pub ui_token_amount: Option<UiTokenAmountWithPrice>,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct UiTokenAmountWithPrice {
    pub amount: String,
    pub decimals: i64,
    pub ui_amount: f64,
...
fn convert_set_authority(
    ...
    SerializableSetAuthority {
        ...
        new_authority: convert_coption(new_authority),
    }
}
    ...
    match ix {
        TokenInstruction::InitializeMint { decimals, mint_authority, freeze_authority } => {
            SerializableTokenInstruction::InitializeMint(SerializableInitializeMint {
                decimals,
                mint_authority,
                freeze_authority: convert_coption(freeze_authority),
            })
        }
